...
final class Hpack {
    ...
    static final class Writer {
        ...
        Writer(int i, boolean z, Buffer buffer) {
            this.smallestHeaderTableSizeSetting = com.google.protobuf.Reader.READ_DONE;
            Header[] headerArr = new Header[8];
            this.dynamicTable = headerArr;
            this.nextDynamicTableIndex = headerArr.length - 1;
            this.headerTableSizeSetting = i;
        ...
        void writeHeaders(List<Header> list) throws IOException {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (length2 != -1) {
                    writeInt(length2, Hpack.PREFIX_7_BITS, 128);
                } else if (length != -1) {
        ...
        void resizeHeaderTable(int i) {
            this.headerTableSizeSetting = i;
            int iMin = Math.min(i, Hpack.SETTINGS_HEADER_TABLE_SIZE_LIMIT);
            int i2 = this.maxDynamicTableByteCount;
            if (i2 == iMin) {
                return;
            }
