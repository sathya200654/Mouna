...
/* JADX INFO: compiled from: TextNotificationPage.kt */
/* JADX INFO: loaded from: C:\Users\abcsa\Downloads\Mouna\dex_temp\classes5.dex */
@Metadata(d1 = {"\u0000 \n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001aG\u0010\u0000\u001a\u00020\u00012\b\b\u0002\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0012\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u00010\u00072\u0012\u0010\t\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u00010\u0007H\u0007¢\u0006\u0002\u0010\n¨\u0006\u000b"}, d2 = {"TextNotificationPage", "", "modifier", "Landroidx/compose/ui/Modifier;", "pageData", "Lcom/deepvisiontech/letstalksigntranscriptionapp/current/notifications/domain/model/NotificationData;", "onSubmitClick", "Lkotlin/Function1;", "Lcom/deepvisiontech/letstalksigntranscriptionapp/current/notifications/domain/model/NotificationResponseType;", "onCancelClick", "(Landroidx/compose/ui/Modifier;Lcom/deepvisiontech/letstalksigntranscriptionapp/current/notifications/domain/model/NotificationData;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "app_release"}, k = 2, mv = {2, 2, 0}, xi = 48)
public final class TextNotificationPageKt {
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit TextNotificationPage$lambda$11(Modifier modifier, NotificationData notificationData, Function1 function1, Function1 function2, int i, int i2, Composer composer, int i3) {
        TextNotificationPage(modifier, notificationData, function1, function2, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }

    public static final void TextNotificationPage(Modifier modifier, final NotificationData notificationData, final Function1<? super NotificationResponseType, Unit> function1, final Function1<? super NotificationResponseType, Unit> function2, Composer composer, final int i, final int i2) {
        Modifier modifier2;
        int i3;
        ...
        Composer composerStartRestartGroup = composer.startRestartGroup(-874872763);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TextNotificationPage)P(!1,3,2)26@1181L2213:TextNotificationPage.kt#om2ogl");
        int i5 = i2 & 1;
        if (i5 != 0) {
            i3 = i | 6;
            modifier2 = modifier;
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & 1171) != 1170, i3 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-874872763, i3, -1, "com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.presentation.screens.TextNotificationPage (TextNotificationPage.kt:25)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -560800935, "C30@1293L778,53@2081L1307:TextNotificationPage.kt#om2ogl");
            float f = 8;
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1918620592, "C39@1634L10,40@1699L11,37@1547L282,47@1929L10,45@1843L218:TextNotificationPage.kt#om2ogl");
            float f2 = 4;
            int i6 = i3;
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1225588892, "C:TextNotificationPage.kt#om2ogl");
            final NotificationResponseType primaryAction = notificationData.getPrimaryAction();
            if (primaryAction == null) {
                composerStartRestartGroup.startReplaceGroup(-1225578416);
                composerStartRestartGroup.endReplaceGroup();
                str = "CC(remember):TextNotificationPage.kt#9igjgp";
                i4 = i6;
            } else {
                composerStartRestartGroup.startReplaceGroup(-1225578415);
                ComposerKt.sourceInformation(composerStartRestartGroup, "*62@2419L85,66@2617L11,67@2704L11,65@2550L204,69@2773L185,61@2377L581");
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1970509164, "CC(remember):TextNotificationPage.kt#9igjgp");
                boolean zChangedInstance = composerStartRestartGroup.changedInstance(notificationData) | ((i6 & 896) == 256);
                Object objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChangedInstance || objRememberedValue == Composer.Companion.getEmpty()) {
                    objRememberedValue = new Function0() { // from class: com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.presentation.screens.TextNotificationPageKt$$ExternalSyntheticLambda0
                        public final Object invoke() {
                            return TextNotificationPageKt.TextNotificationPage$lambda$10$lambda$9$lambda$4$lambda$2$lambda$1(function1, notificationData);
                        }
                    };
                ...
                str = "CC(remember):TextNotificationPage.kt#9igjgp";
                i4 = i6;
                ButtonKt.TextButton((Function0) objRememberedValue, (Modifier) null, false, (Shape) null, ButtonDefaults.INSTANCE.buttonColors-ro_MJ88(MaterialTheme.INSTANCE.getColorScheme(composerStartRestartGroup, MaterialTheme.$stable).getPrimaryContainer-0d7_KjU(), MaterialTheme.INSTANCE.getColorScheme(composerStartRestartGroup, MaterialTheme.$stable).getOnPrimaryContainer-0d7_KjU(), 0L, 0L, composerStartRestartGroup, ButtonDefaults.$stable << 12, 12), (ButtonElevation) null, (BorderStroke) null, (PaddingValues) null, (MutableInteractionSource) null, ComposableLambdaKt.rememberComposableLambda(172959778, true, new Function3() { // from class: com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.presentation.screens.TextNotificationPageKt$$ExternalSyntheticLambda1
                    public final Object invoke(Object obj, Object obj2, Object obj3) {
                        return TextNotificationPageKt.TextNotificationPage$lambda$10$lambda$9$lambda$4$lambda$3(primaryAction, (RowScope) obj, (Composer) obj2, ((Integer) obj3).intValue());
                    }
                }, composerStartRestartGroup, 54), composerStartRestartGroup, 805306368, 494);
                composerStartRestartGroup = composerStartRestartGroup;
            ...
            if (secondaryAction == null) {
                composerStartRestartGroup.startReplaceGroup(-1224934453);
                composerStartRestartGroup.endReplaceGroup();
            } else {
                composerStartRestartGroup.startReplaceGroup(-1224934452);
                ComposerKt.sourceInformation(composerStartRestartGroup, "*79@3076L87,82@3182L182,78@3034L330");
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 572039885, str);
                ...
                if (zChangedInstance2 || objRememberedValue2 == Composer.Companion.getEmpty()) {
                    objRememberedValue2 = new Function0() { // from class: com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.presentation.screens.TextNotificationPageKt$$ExternalSyntheticLambda2
                        public final Object invoke() {
                            return TextNotificationPageKt.TextNotificationPage$lambda$10$lambda$9$lambda$8$lambda$6$lambda$5(function2, notificationData);
                        }
                    };
                ...
                ButtonKt.TextButton((Function0) objRememberedValue2, (Modifier) null, false, (Shape) null, (ButtonColors) null, (ButtonElevation) null, (BorderStroke) null, (PaddingValues) null, (MutableInteractionSource) null, ComposableLambdaKt.rememberComposableLambda(-1561844391, true, new Function3() { // from class: com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.presentation.screens.TextNotificationPageKt$$ExternalSyntheticLambda3
                    public final Object invoke(Object obj, Object obj2, Object obj3) {
                        return TextNotificationPageKt.TextNotificationPage$lambda$10$lambda$9$lambda$8$lambda$7(secondaryAction, (RowScope) obj, (Composer) obj2, ((Integer) obj3).intValue());
                    }
                }, composerStartRestartGroup, 54), composer5, 805306368, 510);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.presentation.screens.TextNotificationPageKt$$ExternalSyntheticLambda4
                public final Object invoke(Object obj, Object obj2) {
                    return TextNotificationPageKt.TextNotificationPage$lambda$11(modifier3, notificationData, function1, function2, i, i2, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit TextNotificationPage$lambda$10$lambda$9$lambda$4$lambda$2$lambda$1(Function1 function1, NotificationData notificationData) {
        function1.invoke(notificationData.getPrimaryAction());
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit TextNotificationPage$lambda$10$lambda$9$lambda$4$lambda$3(NotificationResponseType notificationResponseType, RowScope rowScope, Composer composer, int i) {
        Intrinsics.checkNotNullParameter(rowScope, "$this$TextButton");
        ComposerKt.sourceInformation(composer, "C72@2894L10,70@2795L145:TextNotificationPage.kt#om2ogl");
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(172959778, i, -1, "com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.presentation.screens.TextNotificationPage.<anonymous>.<anonymous>.<anonymous>.<anonymous> (TextNotificationPage.kt:70)");
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit TextNotificationPage$lambda$10$lambda$9$lambda$8$lambda$6$lambda$5(Function1 function1, NotificationData notificationData) {
        function1.invoke(notificationData.getSecondaryAction());
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit TextNotificationPage$lambda$10$lambda$9$lambda$8$lambda$7(NotificationResponseType notificationResponseType, RowScope rowScope, Composer composer, int i) {
        Intrinsics.checkNotNullParameter(rowScope, "$this$TextButton");
        ComposerKt.sourceInformation(composer, "C85@3303L10,83@3204L142:TextNotificationPage.kt#om2ogl");
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            composer.skipToGroupEnd();
        } else {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1561844391, i, -1, "com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.presentation.screens.TextNotificationPage.<anonymous>.<anonymous>.<anonymous>.<anonymous> (TextNotificationPage.kt:83)");
            }
