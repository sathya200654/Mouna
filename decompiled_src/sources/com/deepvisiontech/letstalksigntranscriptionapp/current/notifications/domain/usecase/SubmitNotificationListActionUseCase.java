...
/* JADX INFO: compiled from: SubmitNotificationListActionUseCase.kt */
/* JADX INFO: loaded from: C:\Users\abcsa\Downloads\Mouna\dex_temp\classes5.dex */
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010 \n\u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0019\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007J2\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\f0\u0010H\u0086B¢\u0006\u0002\u0010\u0011R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, d2 = {"Lcom/deepvisiontech/letstalksigntranscriptionapp/current/notifications/domain/usecase/SubmitNotificationListActionUseCase;", "", "notificationRepository", "Lcom/deepvisiontech/letstalksigntranscriptionapp/current/notifications/domain/repository/NotificationRepository;", "sessionRepository", "Lcom/deepvisiontech/letstalksigntranscriptionapp/current/auth/domain/repository/SessionRepository;", "<init>", "(Lcom/deepvisiontech/letstalksigntranscriptionapp/current/notifications/domain/repository/NotificationRepository;Lcom/deepvisiontech/letstalksigntranscriptionapp/current/auth/domain/repository/SessionRepository;)V", "invoke", "Lcom/deepvisiontech/letstalksigntranscriptionapp/current/common/domain/model/response/ResponseResource;", "", "notificationId", "", "pageId", "", "selectedOptions", "", "(Ljava/lang/String;JLjava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "app_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class SubmitNotificationListActionUseCase {
    public static final int $stable = 0;
    private final NotificationRepository notificationRepository;
    private final SessionRepository sessionRepository;

    /* JADX INFO: renamed from: com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.domain.usecase.SubmitNotificationListActionUseCase$invoke$1, reason: invalid class name */
    /* JADX INFO: compiled from: SubmitNotificationListActionUseCase.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    @DebugMetadata(c = "com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.domain.usecase.SubmitNotificationListActionUseCase", f = "SubmitNotificationListActionUseCase.kt", i = {0, 0, 0, 1, 1, 1, 1}, l = {18, 20}, m = "invoke", n = {"notificationId", "selectedOptions", "pageId", "notificationId", "selectedOptions", "gmailId", "pageId"}, s = {"L$0", "L$1", "J$0", "L$0", "L$1", "L$2", "J$0"})
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return SubmitNotificationListActionUseCase.this.invoke(null, 0L, null, (Continuation) this);
        }
    }

    @Inject
    public SubmitNotificationListActionUseCase(NotificationRepository notificationRepository, SessionRepository sessionRepository) {
    ...
    */
    public final java.lang.Object invoke(java.lang.String r9, long r10, java.util.List<java.lang.String> r12, kotlin.coroutines.Continuation<? super com.deepvisiontech.letstalksigntranscriptionapp.current.common.domain.model.response.ResponseResource<kotlin.Unit>> r13) throws kotlin.NoWhenBranchMatchedException {
        /*
            r8 = this;
            boolean r0 = r13 instanceof com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.domain.usecase.SubmitNotificationListActionUseCase.AnonymousClass1
            if (r0 == 0) goto L14
            r0 = r13
            com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.domain.usecase.SubmitNotificationListActionUseCase$invoke$1 r0 = (com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.domain.usecase.SubmitNotificationListActionUseCase.AnonymousClass1) r0
            int r1 = r0.label
            ...
            goto L19
        L14:
            com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.domain.usecase.SubmitNotificationListActionUseCase$invoke$1 r0 = new com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.domain.usecase.SubmitNotificationListActionUseCase$invoke$1
            r0.<init>(r13)
        L19:
            r7 = r0
        ...
        L67:
            ...
            r7.label = r2
            r2 = r9
            java.lang.Object r13 = r1.submitListAction(r2, r3, r5, r6, r7)
            if (r13 != r0) goto L98
        L97:
            return r0
        L98:
        ...
        Lad:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.deepvisiontech.letstalksigntranscriptionapp.current.notifications.domain.usecase.SubmitNotificationListActionUseCase.invoke(java.lang.String, long, java.util.List, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
