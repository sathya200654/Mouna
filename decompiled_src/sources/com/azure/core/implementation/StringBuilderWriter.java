...
public final class StringBuilderWriter extends Writer {
    private static final ClientLogger LOGGER = new ClientLogger((Class<?>) StringBuilderWriter.class);
    ...
    private void ensureOpen() throws IOException {
        if (this.closed) {
            throw ((IOException) LOGGER.logThrowableAsError(new IOException("Writer has been closed.")));
        }
    }
}
