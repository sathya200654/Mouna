...
public class JsonParserSequence extends JsonParserDelegate {
    ...
    public static JsonParserSequence createFlattened(boolean z, JsonParser jsonParser, JsonParser jsonParser2) {
        ...
        return new JsonParserSequence(z, (JsonParser[]) arrayList.toArray(new JsonParser[0]));
    }
    ...
    @Override // com.azure.json.implementation.jackson.core.util.JsonParserDelegate, com.azure.json.implementation.jackson.core.JsonParser, java.io.Closeable, java.lang.AutoCloseable
    ...
    @Override // com.azure.json.implementation.jackson.core.util.JsonParserDelegate, com.azure.json.implementation.jackson.core.JsonParser
