...
public final class JsonStringEncoder {
    ...
    public char[] quoteAsString(String str) {
        ...
        loop0: while (i < length) {
            ...
            int i_appendNumeric = i5 < 0 ? _appendNumeric(cCharAt2, cArr_qbuf) : _appendNamed(i5, cArr_qbuf);
            ...
            if (i6 > cArrFinishCurrentSegment.length) {
                ...
                System.arraycopy(cArr_qbuf, 0, cArrFinishCurrentSegment, i2, i_appendNumeric);
                i2 = i6;
            }
            i = i4;
        }
        ...
        while (i < length2) {
            do {
                ...
                if (cCharAt >= length || iArr[cCharAt] == 0) {
                    ...
                    sb.append(cArr_qbuf, 0, i3 < 0 ? _appendNumeric(cCharAt2, cArr_qbuf) : _appendNamed(i3, cArr_qbuf));
                    i = i2;
                }
            } while (i < length2);
            return;
