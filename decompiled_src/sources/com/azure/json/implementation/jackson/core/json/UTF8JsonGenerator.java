...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    private void _writeUnq(SerializableString serializableString) throws IOException {
    ...
    private void _writeSegmentedRaw(char[] cArr, int i, int i2) throws IOException {
        byte[] bArr = this._outputBuffer;
        int i3 = i2 + i;
        while (i < i3) {
            do {
                ...
                if (c < 128) {
                    ...
                    if (c2 < 2048) {
                        ...
                        i = _outputRawMultiByteChar(c2, cArr, i5, i3);
                    }
                }
            } while (i < i3);
            return;
    ...
    private void _writeBytes(byte[] bArr, int i, int i2) throws IOException {
    ...
    private void _writeStringSegments(String str, boolean z) throws IOException {
        if (z) {
            if (this._outputTail >= this._outputEnd) {
                _flushBuffer();
            }
    ...
    private void _writeStringSegments(char[] cArr, int i, int i2) throws IOException {
        do {
    ...
    private void _writeStringSegments(String str, int i, int i2) throws IOException {
        do {
            int iMin = Math.min(this._outputMaxContiguous, i2);
            if (this._outputTail + iMin > this._outputEnd) {
                _flushBuffer();
    ...
    private void _writeStringSegment(char[] cArr, int i, int i2) throws IOException {
        int i3 = i2 + i;
        int i4 = this._outputTail;
        byte[] bArr = this._outputBuffer;
    ...
    private void _writeStringSegment(String str, int i, int i2) throws IOException {
        int i3 = i2 + i;
        int i4 = this._outputTail;
        byte[] bArr = this._outputBuffer;
        int[] iArr = this._outputEscapes;
    ...
    private void _writeStringSegment2(char[] cArr, int i, int i2) throws IOException {
    ...
    private void _writeStringSegment2(String str, int i, int i2) throws IOException {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i_outputMultiByteChar = this._outputTail;
    ...
    private void _writeStringSegmentASCII2(char[] cArr, int i, int i2) throws IOException {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i_outputMultiByteChar = this._outputTail;
    ...
    private void _writeStringSegmentASCII2(String str, int i, int i2) throws IOException {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i_outputMultiByteChar = this._outputTail;
    ...
    private void _writeCustomStringSegment2(char[] cArr, int i, int i2) throws IOException {
        ...
        byte[] bArr = this._outputBuffer;
        int[] iArr = this._outputEscapes;
        int i3 = this._maximumNonEscapedChar <= 0 ? OkHttpChannelBuilder.DEFAULT_FLOW_CONTROL_WINDOW : this._maximumNonEscapedChar;
    ...
    private void _writeCustomStringSegment2(String str, int i, int i2) throws IOException {
        if (this._outputTail + ((i2 - i) * 6) > this._outputEnd) {
            _flushBuffer();
        }
        int i_outputMultiByteChar = this._outputTail;
    ...
    private int _writeCustomEscape(byte[] bArr, int i, SerializableString serializableString, int i2) throws IOException {
    ...
    protected final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException {
        ...
        while (true) {
            ...
            i6 += 3;
            i5 -= 3;
            int iEncodeBase64Chunk = base64Variant.encodeBase64Chunk(i8 | (bArr2[i7] & UnsignedBytes.MAX_VALUE), uTF8JsonGenerator._outputBuffer, uTF8JsonGenerator._outputTail);
