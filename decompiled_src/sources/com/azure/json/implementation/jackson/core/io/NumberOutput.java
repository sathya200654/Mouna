...
public final class NumberOutput {
    ...
    public static int outputLong(long j, char[] cArr, int i) {
        ...
        if (j2 < 1000000000) {
            i_outputFullBillion = _outputUptoBillion((int) j2, cArr, i);
        } else {
            long j4 = j2 / 1000000000;
            int i_leading3 = _leading3((int) j4, cArr, i);
            i_outputFullBillion = _outputFullBillion((int) (j2 - (1000000000 * j4)), cArr, i_leading3);
        }
        return _outputFullBillion((int) j3, cArr, i_outputFullBillion);
    }
    ...
    public static int outputLong(long j, byte[] bArr, int i) {
        ...
        long j3 = j - (j2 * 1000000000);
        if (j2 < 1000000000) {
            i_outputFullBillion = _outputUptoBillion((int) j2, bArr, i);
        } else {
            long j4 = j2 / 1000000000;
            int i_leading3 = _leading3((int) j4, bArr, i);
            i_outputFullBillion = _outputFullBillion((int) (j2 - (1000000000 * j4)), bArr, i_leading3);
        }
        return _outputFullBillion((int) j3, bArr, i_outputFullBillion);
    }
