...
class FftMultiplier {
    ...
    static BigInteger squareFft(BigInteger bigInteger) {
        ...
        ComplexVector[] rootsOfUnity5 = getRootsOfUnity2(i3);
        fftVector2.applyWeights(rootsOfUnity5[i3]);
        fft(fftVector2, rootsOfUnity5);
        fftVector2.squarePointwise();
        ifft(fftVector2, rootsOfUnity5);
        fftVector2.applyInverseWeights(rootsOfUnity5[i3]);
    ...
    static ComplexVector toFftVector(byte[] bArr, int i, int i2) {
        ...
        while (length > (-i2)) {
            ...
            int intBE = ((FastDoubleSwar.readIntBE(bArr, iMin) >>> ((i6 - length) + (iMin << 3))) & i5) + i7;
            i7 = (i4 - intBE) >>> 31;
            complexVector.real(i8, intBE - ((-i7) & i3));
            i8++;
            length -= i2;
        }
        if (i7 > 0) {
