...
final class JavaBigDecimalFromByteArray extends AbstractBigDecimalParser {
    public BigDecimal parseBigDecimalString(byte[] bArr, int i, int i2) {
        ...
        int i6 = i;
        try {
            int iCheckBounds = checkBounds(bArr.length, i6, i2);
            if (hasManyDigits(i2)) {
                return parseBigDecimalStringWithManyDigits(bArr, i, i2);
            }
            byte bCharAt = charAt(bArr, i6, iCheckBounds);
            boolean z2 = bCharAt == 45;
            if (z2 || bCharAt == 43) {
                i6++;
                bCharAt = charAt(bArr, i6, iCheckBounds);
                if (bCharAt == 0) {
            ...
            while (true) {
                ...
                if (c >= '\n') {
                    ...
                    z3 |= i8 >= 0;
                    int i10 = i9;
                    while (i10 < iCheckBounds - 4 && (iTryToParseFourDigits = FastDoubleSwar.tryToParseFourDigits(bArr, i10 + 1)) >= 0) {
            ...
            if ((b2 | 32) == 101) {
                int i11 = i9 + 1;
                byte bCharAt2 = charAt(bArr, i11, iCheckBounds);
                boolean z4 = bCharAt2 == 45 ? z : false;
                if (z4 || bCharAt2 == 43) {
                    i11 = i9 + 2;
                    bCharAt2 = charAt(bArr, i11, iCheckBounds);
                }
                ...
                while (true) {
                    ...
                    j2 = j4;
                    i11++;
                    char cCharAt = (char) (charAt(bArr, i11, iCheckBounds) - 48);
                    if (cCharAt >= '\n') {
                        break;
                    }
                    j4 = j2;
            ...
            return valueOfBigDecimalString(bArr, i7, i4, i4 + 1, i9, z2, (int) j5);
    ...
    /*  JADX ERROR: Types fix failed
        ...
        Caused by: java.lang.NullPointerException
        */
    java.math.BigDecimal parseBigDecimalStringWithManyDigits(byte[] r22, int r23, int r24) {
        /*
            Method dump skipped, instruction units count: 314
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.internal.shaded.fdp.v2_18_4_1.JavaBigDecimalFromByteArray.parseBigDecimalStringWithManyDigits(byte[], int, int):java.math.BigDecimal");
    }
    ...
    BigDecimal valueOfBigDecimalString(byte[] bArr, int i, int i2, int i3, int i4, boolean z, int i5) {
        ...
        if (i8 <= 0) {
            ...
            bigIntegerNegate = ParseDigitsTaskByteArray.parseDigitsRecursive(bArr, i, i2, navigableMapCreatePowersOfTenFloor16Map, 400);
        } else {
        ...
        if (i6 > 0) {
            if (i7 > 400) {
                ...
                digitsIterative = ParseDigitsTaskByteArray.parseDigitsRecursive(bArr, i3, i4, navigableMapCreatePowersOfTenFloor16Map, 400);
            } else {
