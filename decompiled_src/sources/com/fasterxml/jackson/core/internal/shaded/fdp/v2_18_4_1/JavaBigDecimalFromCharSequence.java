...
final class JavaBigDecimalFromCharSequence extends AbstractBigDecimalParser {
    public BigDecimal parseBigDecimalString(CharSequence charSequence, int i, int i2) {
        ...
        int i6 = i;
        try {
            int iCheckBounds = checkBounds(charSequence.length(), i6, i2);
            if (hasManyDigits(i2)) {
                return parseBigDecimalStringWithManyDigits(charSequence, i, i2);
            }
            char cCharAt = charAt(charSequence, i6, iCheckBounds);
            boolean z2 = cCharAt == '-';
            if (z2 || cCharAt == '+') {
                i6++;
                cCharAt = charAt(charSequence, i6, iCheckBounds);
                if (cCharAt == 0) {
            ...
            if ((cCharAt2 | XmlConsts.CHAR_SPACE) == 101) {
                int i11 = i9 + 1;
                char cCharAt3 = charAt(charSequence, i11, iCheckBounds);
                boolean z4 = cCharAt3 == '-' ? z : false;
                if (z4 || cCharAt3 == '+') {
                    i11 = i9 + 2;
                    cCharAt3 = charAt(charSequence, i11, iCheckBounds);
                }
                ...
                while (true) {
                    ...
                    j2 = j4;
                    i11++;
                    char cCharAt4 = (char) (charAt(charSequence, i11, iCheckBounds) - '0');
                    if (cCharAt4 >= '\n') {
                        break;
                    }
                    j4 = j2;
    ...
    /*  JADX ERROR: Types fix failed
        ...
        Caused by: java.lang.NullPointerException
        */
    java.math.BigDecimal parseBigDecimalStringWithManyDigits(java.lang.CharSequence r22, int r23, int r24) {
        /*
            Method dump skipped, instruction units count: 322
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.internal.shaded.fdp.v2_18_4_1.JavaBigDecimalFromCharSequence.parseBigDecimalStringWithManyDigits(java.lang.CharSequence, int, int):java.math.BigDecimal");
    }
