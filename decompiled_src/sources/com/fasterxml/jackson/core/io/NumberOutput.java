...
public final class NumberOutput {
    ...
    static {
        ...
        sSmallIntStrs = new String[]{"0", DiskLruCache.VERSION, "2", "3", "4", "5", "6", "7", "8", "9", "10"};
    ...
    public static int outputInt(int i, char[] cArr, int i2) {
        ...
        int iDivBy1001 = divBy1000(i);
        int i6 = i - (iDivBy1001 * 1000);
        int iDivBy1002 = divBy1000(iDivBy1001);
        return _full3(i6, cArr, _full3(iDivBy1001 - (iDivBy1002 * 1000), cArr, _leading3(iDivBy1002, cArr, i2)));
    }
    ...
    public static int outputInt(int i, byte[] bArr, int i2) {
        ...
        int iDivBy1001 = divBy1000(i);
        int i7 = i - (iDivBy1001 * 1000);
        int iDivBy1002 = divBy1000(iDivBy1001);
        return _full3(i7, bArr, _full3(iDivBy1001 - (iDivBy1002 * 1000), bArr, _leading3(iDivBy1002, bArr, i2)));
    }
    ...
    private static int _outputUptoBillion(int i, char[] cArr, int i2) {
        ...
        int iDivBy1001 = divBy1000(i);
        int i3 = i - (iDivBy1001 * 1000);
        int iDivBy1002 = divBy1000(iDivBy1001);
        int i4 = iDivBy1001 - (iDivBy1002 * 1000);
        int i_leading3 = _leading3(iDivBy1002, cArr, i2);
    ...
    private static int _outputFullBillion(int i, char[] cArr, int i2) {
        ...
        int iDivBy1001 = divBy1000(iDivBy1000);
        int[] iArr = TRIPLET_TO_CHARS;
        int i4 = iArr[iDivBy1001];
        cArr[i2] = (char) (i4 >> 16);
        cArr[i2 + 1] = (char) ((i4 >> 8) & 127);
        cArr[i2 + 2] = (char) (i4 & 127);
        int i5 = iArr[iDivBy1000 - (iDivBy1001 * 1000)];
    ...
    private static int _outputUptoBillion(int i, byte[] bArr, int i2) {
        ...
        int iDivBy1002 = divBy1000(iDivBy1001);
        int i4 = iDivBy1001 - (iDivBy1002 * 1000);
        int i_leading3 = _leading3(iDivBy1002, bArr, i2);
        int[] iArr = TRIPLET_TO_CHARS;
        int i5 = iArr[i4];
    ...
    private static int _outputFullBillion(int i, byte[] bArr, int i2) {
        ...
        int i3 = i - (iDivBy1000 * 1000);
        int iDivBy1001 = divBy1000(iDivBy1000);
        int i4 = iDivBy1000 - (iDivBy1001 * 1000);
        int[] iArr = TRIPLET_TO_CHARS;
        int i5 = iArr[iDivBy1001];
        bArr[i2] = (byte) (i5 >> 16);
        bArr[i2 + 1] = (byte) (i5 >> 8);
        bArr[i2 + 2] = (byte) i5;
        int i6 = iArr[i4];
