...
public class UTF8StreamJsonParser extends JsonParserBase {
    ...
    */
    ...
    private final JsonToken _parseSignedNumber(boolean z) throws IOException {
        ...
        int i2 = this._inputPtr;
        this._inputPtr = i2 + 1;
        int i_verifyNoLeadingZeroes = bArr[i2] & UnsignedBytes.MAX_VALUE;
    ...
    protected final String parseLongName(int i, int i2, int i3) throws IOException {
        ...
        while (this._inputPtr + 4 <= this._inputEnd) {
            ...
            if (i10 >= iArr4.length) {
                this._quadBuffer = _growNameDecodeBuffer(iArr4, i10);
            }
            int i21 = i10 + 1;
    ...
    protected final void _matchTrue() throws IOException {
        ...
        if (i2 + 3 < this._inputEnd) {
            ...
            if (bArr[i2] == 114) {
                ...
                if (bArr[i3] == 117) {
                    int i5 = i2 + 3;
                    if (bArr[i4] == 101 && ((i = bArr[i5] & UnsignedBytes.MAX_VALUE) < 48 || (i | 32) == 125)) {
                        this._inputPtr = i5;
                        return;
                    }
                }
        ...
        if (i2 + 4 < this._inputEnd) {
            ...
            if (bArr[i2] == 97) {
                ...
                if (bArr[i3] == 108) {
                    ...
                    if (bArr[i4] == 115) {
                        int i6 = i2 + 4;
                        if (bArr[i5] == 101 && ((i = bArr[i6] & UnsignedBytes.MAX_VALUE) < 48 || (i | 32) == 125)) {
                            this._inputPtr = i6;
                            return;
                        }
                    }
    ...
    protected final void _matchNull() throws IOException {
        ...
        if (i2 + 3 < this._inputEnd) {
            ...
            if (bArr[i2] == 117) {
                ...
                if (bArr[i3] == 108) {
                    int i5 = i2 + 3;
                    if (bArr[i4] == 108 && ((i = bArr[i5] & UnsignedBytes.MAX_VALUE) < 48 || (i | 32) == 125)) {
                        this._inputPtr = i5;
                        return;
                    }
                }
