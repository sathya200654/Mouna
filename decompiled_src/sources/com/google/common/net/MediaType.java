...
public final class MediaType {
    ...
    private static final CharMatcher TOKEN_MATCHER = CharMatcher.ascii().and(CharMatcher.javaIsoControl().negate()).and(CharMatcher.isNot(XmlConsts.CHAR_SPACE)).and(CharMatcher.noneOf("()<>@,;:\\\"/[]?="));
    ...
    public Optional<Charset> charset() {
        ...
        if (optionalAbsent == null) {
            ...
            UnmodifiableIterator it = this.parameters.get(CHARSET_ATTRIBUTE).iterator();
            String str = null;
            while (it.hasNext()) {
    ...
    public MediaType withParameters(String attribute, Iterable<String> values) {
        ...
        while (it.hasNext()) {
            ...
            if (!strNormalizeToken.equals(str)) {
    ...
    private static MediaType create(String type, String subtype, Multimap<String, String> parameters) {
        ...
        for (Map.Entry entry : parameters.entries()) {
            ...
            builder.put(strNormalizeToken3, normalizeParameterValue(strNormalizeToken3, (String) entry.getValue()));
        }
    ...
    public int hashCode() {
        ...
        int iHashCode = Objects.hashCode(new Object[]{this.type, this.subtype, parametersAsMap()});
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sbAppend.append("; ");
            PARAMETER_JOINER.appendTo(sbAppend, Multimaps.transformValues(this.parameters, new Function() { // from class: com.google.common.net.MediaType$$ExternalSyntheticLambda0
                public final Object apply(Object obj) {
