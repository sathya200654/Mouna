...
public abstract class Logger {
    ...
    private static final class AndroidLogger extends Logger {
        ...
        public int log(Level level, String format, Object[] args, Throwable throwable) throws NoWhenBranchMatchedException {
    ...
    public static final class FakeLogger extends Logger {
        ...
        public final boolean hasLogMessage(String message) {
            ...
            while (it.hasNext()) {
                if (StringsKt.contains$default((String) it.next(), message, false, 2, (Object) null)) {
                    return true;
                }
            }
            return false;
        ...
        private final String toLogMessage(Level level, String format, Object[] args, Throwable throwable) {
            ...
            return (throwable == null || (string = new StringBuilder().append(level).append(XmlConsts.CHAR_SPACE).append(format).append(XmlConsts.CHAR_SPACE).append(Log.getStackTraceString(throwable)).toString()) == null) ? level + XmlConsts.CHAR_SPACE + format : string;
        }
    }

    /* JADX INFO: compiled from: Logger.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0002\b\t\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0014\u0010\u0002\u001a\u00020\u0003X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006j\u0002\b\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000b¨\u0006\f"}, d2 = {"Lcom/google/firebase/logger/Logger$Level;", "", "priority", "", "(Ljava/lang/String;II)V", "getPriority$com_google_firebase_firebase_common", "()I", "VERBOSE", DefaultLogger.DEBUG, DefaultLogger.INFO, DefaultLogger.WARN, DefaultLogger.ERROR, "com.google.firebase-firebase-common"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public enum Level {
        VERBOSE(2),
        DEBUG(3),
        INFO(4),
