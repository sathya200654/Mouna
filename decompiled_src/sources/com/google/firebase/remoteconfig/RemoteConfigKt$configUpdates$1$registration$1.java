...
public final class RemoteConfigKt$configUpdates$1$registration$1 implements ConfigUpdateListener {
    ...
    public static final void onUpdate$lambda$0(ProducerScope producerScope, ConfigUpdate configUpdate) {
        ...
        ChannelsKt.trySendBlocking((SendChannel) producerScope, configUpdate);
    }
    ...
    public void onError(FirebaseRemoteConfigException error) {
        ...
        CoroutineScopeKt.cancel(this.$$this$callbackFlow, "Error listening for config updates.", (Throwable) error);
    }
}
