...
public class FirebaseRemoteConfig {
    ...
    public Task<FirebaseRemoteConfigInfo> ensureInitialized() {
        ...
        return Tasks.whenAllComplete(new Task[]{task, task2, task3, taskCall, this.firebaseInstallations.getId(), this.firebaseInstallations.getToken(false)}).continueWith(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda9
    ...
    public Task<Boolean> fetchAndActivate() {
        return fetch().onSuccessTask(this.executor, new SuccessContinuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda10
            public final Task then(Object obj) {
                return this.f$0.m2155xebd5994c((Void) obj);
            }
        });
    }
    ...
    /* synthetic */ Task m2155xebd5994c(Void r1) throws Exception {
        return activate();
    }
    ...
    public Task<Boolean> activate() {
        ...
        return Tasks.whenAllComplete(new Task[]{task, task2}).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda0
            public final Object then(Task task3) {
                return this.f$0.m2154x98ca96b0(task, task2, task3);
            }
        });
    }
    ...
    /* synthetic */ Task m2154x98ca96b0(Task task, Task task2, Task task3) throws Exception {
    ...
    public Task<Void> setConfigSettingsAsync(final FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda7
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m2157xd6203cf5(firebaseRemoteConfigSettings);
            }
        });
    }
    ...
    /* synthetic */ Void m2157xd6203cf5(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) throws Exception {
    ...
    public boolean processActivatePutTask(Task<ConfigContainer> task) throws FirebaseException {
    ...
    public Task<Void> setCustomSignals(final CustomSignals customSignals) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m2158x5520461b(customSignals);
            }
        });
    }
    ...
    /* synthetic */ Void m2158x5520461b(CustomSignals customSignals) throws Exception {
