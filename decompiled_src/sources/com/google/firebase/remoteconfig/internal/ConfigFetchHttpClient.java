...
public class ConfigFetchHttpClient {
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map<String, String> map, Long l, Map<String, String> map2) throws FirebaseException {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: com.google.firebase.FirebaseException */
    /* JADX WARN: Byte code manipulation detected: skipped illegal throws declarations: [com.google.firebase.remoteconfig.FirebaseRemoteConfigClientException] */
    private static ConfigContainer extractConfigs(JSONObject jSONObject, Date date) throws FirebaseException {
