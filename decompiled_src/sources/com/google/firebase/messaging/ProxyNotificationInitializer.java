...
final class ProxyNotificationInitializer {
    ...
    static void initialize(Context context) {
        ...
        setEnableProxyNotification(new CameraXViewfinderKt$CameraXViewfinder$viewfinderArgs$2$1$.ExternalSyntheticLambda0(), context, shouldEnableProxyNotification(context));
    }
