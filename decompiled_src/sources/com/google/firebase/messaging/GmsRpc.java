...
class GmsRpc {
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new CameraXViewfinderKt$CameraXViewfinder$viewfinderArgs$2$1$.ExternalSyntheticLambda0(), new Continuation() { // from class: com.google.firebase.messaging.GmsRpc$$ExternalSyntheticLambda0
            public final Object then(Task task2) {
                return this.f$0.m2124xb80eb67f(task2);
            }
        });
    }
    ...
    /* synthetic */ String m2124xb80eb67f(Task task) throws Exception {
