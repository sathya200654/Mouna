...
final class Utf8 {
        ...
        int encodeUtf8(String in, byte[] out, int offset, int length) {
            ...
            while (i4 < length2) {
                ...
                if (cCharAt2 < 128 && i5 < i3) {
                    ...
                    out[i5] = (byte) ((cCharAt2 >>> '\f') | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND);
                    int i9 = i5 + 2;
        ...
        int encodeUtf8(final String in, final byte[] out, final int offset, final int length) {
            ...
            while (i2 < length2) {
                ...
                if (cCharAt2 < 128 && j4 < j5) {
                    ...
                    UnsafeUtil.putByte(out, j4, (byte) ((cCharAt2 >>> '\f') | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND));
                    long j7 = j4 + 2;
                    j3 = j5;
    ...
    private static class DecodeUtil {
        ...
        private static char lowSurrogate(int codePoint) {
            return (char) ((codePoint & FastDoubleMath.DOUBLE_EXPONENT_BIAS) + 56320);
        }
