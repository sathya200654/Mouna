...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            while ((value & (-128)) != 0) {
                try {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    bArr[i] = (byte) ((value | 128) & Constants.MAX_HOST_LENGTH);
                    value >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                }
        ...
        public final void writeFixed32NoTag(int value) throws IOException {
            try {
                ...
                int i2 = i + 1;
                this.position = i2;
                bArr[i] = (byte) (value & Constants.MAX_HOST_LENGTH);
                int i3 = i + 2;
                this.position = i3;
                bArr[i2] = (byte) ((value >> 8) & Constants.MAX_HOST_LENGTH);
                int i4 = i + 3;
                this.position = i4;
                bArr[i3] = (byte) ((value >> 16) & Constants.MAX_HOST_LENGTH);
                this.position = i + 4;
                bArr[i4] = (byte) ((value >> 24) & Constants.MAX_HOST_LENGTH);
            } catch (IndexOutOfBoundsException e) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
            }
        }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                while ((value & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, i, (byte) ((((int) value) | 128) & Constants.MAX_HOST_LENGTH));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & (-128)) != 0) {
                try {
                    ...
                    this.position = i3 + 1;
                    bArr3[i3] = (byte) ((((int) value) | 128) & Constants.MAX_HOST_LENGTH);
                    value >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                }
        ...
        public final void writeFixed64NoTag(long value) throws IOException {
            try {
                ...
                int i2 = i + 1;
                this.position = i2;
                bArr[i] = (byte) (((int) value) & Constants.MAX_HOST_LENGTH);
                int i3 = i + 2;
                this.position = i3;
                bArr[i2] = (byte) (((int) (value >> 8)) & Constants.MAX_HOST_LENGTH);
                int i4 = i + 3;
                this.position = i4;
                bArr[i3] = (byte) (((int) (value >> 16)) & Constants.MAX_HOST_LENGTH);
                int i5 = i + 4;
                this.position = i5;
                bArr[i4] = (byte) (((int) (value >> 24)) & Constants.MAX_HOST_LENGTH);
                int i6 = i + 5;
                this.position = i6;
                bArr[i5] = (byte) (((int) (value >> 32)) & Constants.MAX_HOST_LENGTH);
                int i7 = i + 6;
                this.position = i7;
                bArr[i6] = (byte) (((int) (value >> 40)) & Constants.MAX_HOST_LENGTH);
                int i8 = i + 7;
                this.position = i8;
                bArr[i7] = (byte) (((int) (value >> 48)) & Constants.MAX_HOST_LENGTH);
                this.position = i + 8;
                bArr[i8] = (byte) (((int) (value >> 56)) & Constants.MAX_HOST_LENGTH);
            } catch (IndexOutOfBoundsException e) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
            }
        }
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            while ((value & (-128)) != 0) {
                try {
                    this.buffer.put((byte) ((value | 128) & Constants.MAX_HOST_LENGTH));
                    value >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while (((-128) & value) != 0) {
                try {
                    this.buffer.put((byte) ((((int) value) | 128) & Constants.MAX_HOST_LENGTH));
                    value >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & (-128)) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((value | 128) & Constants.MAX_HOST_LENGTH));
                    value >>>= 7;
                }
            ...
            while (true) {
                ...
                if ((value & (-128)) == 0) {
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((value | 128) & Constants.MAX_HOST_LENGTH));
                    value >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & (-128)) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((((int) value) | 128) & Constants.MAX_HOST_LENGTH));
                    value >>>= 7;
                }
                long j2 = this.position;
                this.position = 1 + j2;
            ...
            while (true) {
                ...
                if ((value & (-128)) == 0) {
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((((int) value) | 128) & Constants.MAX_HOST_LENGTH));
                    value >>>= 7;
                }
            }
        }
        ...
        final void bufferUInt32NoTag(int value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, i, (byte) ((value | 128) & Constants.MAX_HOST_LENGTH));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & (-128)) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((value | 128) & Constants.MAX_HOST_LENGTH);
                this.totalBytesWritten++;
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
