...
final class ArrayDecoders {
    ...
    static int decodeFixed32(byte[] data, int position) {
        return ((data[position + 3] & UnsignedBytes.MAX_VALUE) << 24) | (data[position] & UnsignedBytes.MAX_VALUE) | ((data[position + 1] & UnsignedBytes.MAX_VALUE) << 8) | ((data[position + 2] & UnsignedBytes.MAX_VALUE) << 16);
    }
