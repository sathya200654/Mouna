...
public abstract class CodedInputStream {
    ...
    private static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        */
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            this.pos = 4 + j;
            return (UnsafeUtil.getByte(j) & UnsignedBytes.MAX_VALUE) | ((UnsafeUtil.getByte(1 + j) & UnsignedBytes.MAX_VALUE) << 8) | ((UnsafeUtil.getByte(2 + j) & UnsignedBytes.MAX_VALUE) << 16) | ((UnsafeUtil.getByte(j + 3) & UnsignedBytes.MAX_VALUE) << 24);
        }
    ...
    private static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return ((readRawByte() & UnsignedBytes.MAX_VALUE) << 24) | (readRawByte() & UnsignedBytes.MAX_VALUE) | ((readRawByte() & UnsignedBytes.MAX_VALUE) << 8) | ((readRawByte() & UnsignedBytes.MAX_VALUE) << 16);
        }
