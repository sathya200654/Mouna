...
public final class IntArrayProtoAdapter extends ProtoAdapter<int[]> {
    ...
    public IntArrayProtoAdapter(ProtoAdapter<Integer> protoAdapter) {
        super(FieldEncoding.LENGTH_DELIMITED, (KClass<?>) Reflection.getOrCreateKotlinClass(int[].class), (String) null, protoAdapter.getSyntax(), new int[0]);
