...
public class GifHeaderParser {
    ...
    private void readGraphicControlExt() {
        read();
        int i = read();
        this.header.currentFrame.dispose = (i & GCE_MASK_DISPOSAL_METHOD) >> 2;
    ...
    private int[] readColorTable(int i) {
        ...
        try {
            ...
            while (i2 < i) {
                ...
                int i5 = i3 + 2;
                int i6 = bArr[i3 + 1] & UnsignedBytes.MAX_VALUE;
                i3 += 3;
                int i7 = i2 + 1;
                iArr[i2] = (i6 << 8) | (i4 << 16) | DividerAttributes.COLOR_SYSTEM_DEFAULT | (bArr[i5] & UnsignedBytes.MAX_VALUE);
                i2 = i7;
            }
            return iArr;
