...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private android.app.Fragment findFragment(View view, Activity activity) {
        ...
        while (!view.equals(viewFindViewById) && (fragment = (android.app.Fragment) this.tempViewToFragment.get(view)) == null && (view.getParent() instanceof View)) {
            view = (View) view.getParent();
        }
        this.tempViewToFragment.clear();
        return fragment;
    ...
    public boolean handleMessage(Message message) {
        ...
        if (z && objRemove == null && Log.isLoggable(TAG, 5)) {
