...
public final class ScalingLazyColumnDefaults {
    ...
    public static /* synthetic */ ScalingParams scalingParams$default(ScalingLazyColumnDefaults scalingLazyColumnDefaults, float f, float f2, float f3, float f4, float f5, float f6, Easing easing, Function1 function1, int i, Object obj) {
        ...
        if ((i & 128) != 0) {
            function1 = new Function1<Constraints, Integer>() { // from class: androidx.wear.compose.foundation.lazy.ScalingLazyColumnDefaults.scalingParams.1
                public /* bridge */ /* synthetic */ Object invoke(Object obj2) {
                    return m450invokeBRTryo0(((Constraints) obj2).unbox-impl());
                }

                /* JADX INFO: renamed from: invoke-BRTryo0, reason: not valid java name */
                public final Integer m450invokeBRTryo0(long j) {
    ...
    public final FlingBehavior m449snapFlingBehavioruFdPcIQ(ScalingLazyListState scalingLazyListState, float f, DecayAnimationSpec<Float> decayAnimationSpec, Composer composer, int i, int i2) {
        ComposerKt.sourceInformationMarkerStart(composer, 1861298760, "C(snapFlingBehavior)P(2,1:c#ui.unit.Dp)*745@39277L7,746@39328L212:ScalingLazyColumn.kt#n8g2qx");
        if ((i2 & 2) != 0) {
        ...
        ComposerKt.sourceInformationMarkerStart(composer, -231020952, "CC(remember):ScalingLazyColumn.kt#9igjgp");
