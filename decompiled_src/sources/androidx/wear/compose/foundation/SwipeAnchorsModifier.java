...
final class SwipeAnchorsModifier extends InspectorValueInfo implements LayoutModifier, OnRemeasuredModifier {
    ...
    public SwipeAnchorsModifier(Function1<? super Density, Unit> function1, Function1<? super IntSize, Unit> function2, Function1<? super InspectorInfo, Unit> function3) {
        super(function3);
    ...
    public MeasureResult m408measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeable.getWidth(), placeable.getHeight(), (Map) null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.wear.compose.foundation.SwipeAnchorsModifier$measure$1
    ...
    public void m409onRemeasuredozmzZPI(long size) {
