...
public final class ViewPager2 extends ViewGroup {
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        void updatePageAccessibilityActions() {
            ...
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                ViewCompat.replaceAccessibilityAction(viewPager2, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(android.R.id.accessibilityActionPageDown, (CharSequence) null), (CharSequence) null, this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                ViewCompat.replaceAccessibilityAction(viewPager2, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(android.R.id.accessibilityActionPageUp, (CharSequence) null), (CharSequence) null, this.mActionPageBackward);
            }
        }
