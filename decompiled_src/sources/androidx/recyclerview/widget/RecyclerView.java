...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
  ...
  0x00de: PHI (r1v45 int) = (r1v25 int), (r1v49 int) binds: [B:41:0x00c7, B:45:0x00da] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private float getSplineFlingDistance(int i) {
        double dLog = Math.log((Math.abs(i) * 0.35f) / (this.mPhysicalCoef * SCROLL_FRICTION));
    ...
    class ViewFlinger implements Runnable {
        ...
        public void fling(int i, int i2) {
            ...
            this.mOverScroller.fling(0, 0, i, i2, Integer.MIN_VALUE, Reader.READ_DONE, Integer.MIN_VALUE, Reader.READ_DONE);
            postOnAnimation();
        }
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Code duplicated, block: B:110:0x0249  */
        ...
        /* JADX WARN: Code duplicated, block: B:117:0x0274 A[ADDED_TO_REGION] */
