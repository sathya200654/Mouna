    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i10 = 0; i10 < i5; i10++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i7) {
                ...
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i12, layoutParams.width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i7 - i11, Ints.MAX_POWER_OF_TWO);
                } else {
                    int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i7 - i12, Ints.MAX_POWER_OF_TWO);
                    childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i11, layoutParams.height, false);
