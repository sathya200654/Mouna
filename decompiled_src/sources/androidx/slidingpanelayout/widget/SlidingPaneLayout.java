...
public class SlidingPaneLayout extends ViewGroup {
  ...
  0x00b0: PHI (r13v2 float) = (r13v1 float), (r13v3 float) binds: [B:36:0x00a5, B:38:0x00ac] A[DONT_GENERATE, DONT_INLINE]] */
                        ...
                        if (!z3 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z3) {
                                    ...
                                    i4 = i9;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth3 + ((int) ((layoutParams2.weight * Math.max(0, i8)) / f)), Ints.MAX_POWER_OF_TWO), iMakeMeasureSpec);
                                }
                            }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [android.os.Parcelable, androidx.slidingpanelayout.widget.SlidingPaneLayout$SavedState] */
    @Override // android.view.View
