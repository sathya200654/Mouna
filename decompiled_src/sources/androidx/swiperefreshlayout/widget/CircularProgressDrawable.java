...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private static final int[] COLORS = {DividerAttributes.COLOR_SYSTEM_DEFAULT};
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        int i4 = (i >> 16) & Constants.MAX_HOST_LENGTH;
        int i5 = (i >> 8) & Constants.MAX_HOST_LENGTH;
        int i6 = i & Constants.MAX_HOST_LENGTH;
        return ((i3 + ((int) ((((i2 >> 24) & Constants.MAX_HOST_LENGTH) - i3) * f))) << 24) | ((i4 + ((int) ((((i2 >> 16) & Constants.MAX_HOST_LENGTH) - i4) * f))) << 16) | ((i5 + ((int) ((((i2 >> 8) & Constants.MAX_HOST_LENGTH) - i5) * f))) << 8) | (i6 + ((int) (f * ((i2 & Constants.MAX_HOST_LENGTH) - i6))));
    }
