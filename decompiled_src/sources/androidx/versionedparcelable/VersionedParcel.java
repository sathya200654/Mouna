...
public abstract class VersionedParcel {
    ...
    public byte readByte(byte b, int i) {
        return !readField(i) ? b : (byte) (readInt() & Constants.MAX_HOST_LENGTH);
    }
    ...
    public <K, V> Map<K, V> readMap(Map<K, V> map, int i) {
        ...
        ClosingFuture.CloseableList closeableList = (Map<K, V>) new ArrayMap();
        if (i2 != 0) {
            ArrayList arrayList = new ArrayList();
            ArrayList arrayList2 = new ArrayList();
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                closeableList.put(arrayList.get(i3), arrayList2.get(i3));
            }
        }
