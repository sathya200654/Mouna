...
class VersionedParcelStream extends VersionedParcel {
    ...
    private static final Charset UTF_16 = Charset.forName(CharsetNames.CS_UTF16);
    int mCount;
    ...
    public boolean readField(int i) {
        while (true) {
            try {
                ...
                this.mCount = 0;
                int i6 = i5 & OkHttpChannelBuilder.DEFAULT_FLOW_CONTROL_WINDOW;
                if (i6 == 65535) {
                    i6 = this.mMasterInput.readInt();
                }
                this.mFieldId = (i5 >> 16) & OkHttpChannelBuilder.DEFAULT_FLOW_CONTROL_WINDOW;
                this.mFieldSize = i6;
