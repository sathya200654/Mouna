...
public final class ParcelableListSerializer implements KSerializer<List<? extends Parcelable>> {
    ...
    public void serialize(Encoder encoder, List<? extends Parcelable> value) {
        ...
        SavedStateWriter.m145putParcelableListimpl(SavedStateWriter.m119constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public List<Parcelable> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m85getParcelableListimpl(SavedStateReader.m33constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
