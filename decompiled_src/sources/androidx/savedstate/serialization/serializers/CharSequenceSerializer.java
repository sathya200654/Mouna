...
public final class CharSequenceSerializer implements KSerializer<CharSequence> {
    ...
    public void serialize(Encoder encoder, CharSequence value) {
        ...
        SavedStateWriter.m129putCharSequenceimpl(SavedStateWriter.m119constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }

    /* JADX INFO: renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public CharSequence m165deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m50getCharSequenceimpl(SavedStateReader.m33constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
