...
public final class SparseParcelableArraySerializer implements KSerializer<SparseArray<Parcelable>> {
    ...
    public void serialize(Encoder encoder, SparseArray<Parcelable> value) {
        ...
        SavedStateWriter.m151putSparseParcelableArrayimpl(SavedStateWriter.m119constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }

    /* JADX INFO: renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public SparseArray<Parcelable> m177deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m101getSparseParcelableArrayimpl(SavedStateReader.m33constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
