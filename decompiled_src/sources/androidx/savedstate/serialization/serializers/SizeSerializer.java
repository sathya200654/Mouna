...
public final class SizeSerializer implements KSerializer<Size> {
    ...
    public void serialize(Encoder encoder, Size value) {
        ...
        SavedStateWriter.m149putSizeimpl(SavedStateWriter.m119constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }

    /* JADX INFO: renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public Size m174deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m96getSizeimpl(SavedStateReader.m33constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
