...
public final class ParcelableArraySerializer implements KSerializer<Parcelable[]> {
    ...
    public void serialize(Encoder encoder, Parcelable[] value) {
        ...
        SavedStateWriter.m144putParcelableArrayimpl(SavedStateWriter.m119constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public Parcelable[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m81getParcelableArrayimpl(SavedStateReader.m33constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
