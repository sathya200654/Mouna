...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    public void serialize(Encoder encoder, IBinder value) {
        ...
        SavedStateWriter.m124putBinderimpl(SavedStateWriter.m119constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }

    /* JADX INFO: renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public IBinder m166deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m40getBinderimpl(SavedStateReader.m33constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
